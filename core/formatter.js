...
const stringWidth = require('../util/stringWidth.js');
...
const formatMultiline = (lines, prefix, maxWidth = Math.floor(process.stdout.columns * 0.9) || 80) => {
  ...
  lines.forEach((line, i) => {
    const availWidth = maxWidth - (i === 0 ? visualPrefixLength : stripAnsi(linePad).length);
...
function splitIntoVisualChunks(text, maxWidth) {
